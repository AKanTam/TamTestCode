...
#ifdef WIN32
#if defined (_HTTP_H3AP_)
#define	HTTP_H3AP_EXPORT	__declspec(dllexport)
#else
#define	HTTP_H3AP_EXPORT	__declspec(dllimport)
#endif	// _MODBUS_TCP_
#else
#define	HTTP_H3AP_EXPORT
#endif

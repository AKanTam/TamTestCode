...
#ifdef WIN32
#if defined(_HTTP_JXSERVER_LIGHT_)
#define HTTP_JXSERVER_LIGHT_EXPORT __declspec(dllexport)
#else
#define HTTP_JXSERVER_LIGHT_EXPORT __declspec(dllimport)
#endif // _MODBUS_TCP_
#else
#define HTTP_JXSERVER_LIGHT_EXPORT
#endif

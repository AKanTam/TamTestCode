...
#ifdef WIN32
#if defined(_HTTP_TOILET_AHUA_)
#define HTTP_TOILET_AHUA_EXPORT __declspec(dllexport)
#else
#define HTTP_TOILET_AHUA_EXPORT __declspec(dllimport)
#endif // _MODBUS_TCP_
#else
#define HTTP_TOILET_AHUA_EXPORT
#endif

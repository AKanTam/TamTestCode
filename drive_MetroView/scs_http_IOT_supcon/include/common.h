...
#ifdef WIN32
#if defined(_HTTP_IOT_SUPCON_)
#define HTTP_IOT_SUPCON_EXPORT __declspec(dllexport)
#else
#define HTTP_IOT_SUPCON_EXPORT __declspec(dllimport)
#endif // _MODBUS_TCP_
#else
#define HTTP_IOT_SUPCON_EXPORT
#endif

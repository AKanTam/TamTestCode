...
#ifdef WIN32
#if defined(_HTTPSERVER_TOILET_JIASHAN_)
#define HTTPSERVER_TOILET_JIASHAN_EXPORT __declspec(dllexport)
#else
#define HTTPSERVER_TOILET_JIASHAN_EXPORT __declspec(dllimport)
#endif // _MODBUS_TCP_
#else
#define HTTPSERVER_TOILET_JIASHAN_EXPORT
#endif
